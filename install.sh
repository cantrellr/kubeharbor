...
export HARBOR_LEAF_CERT_SOURCE HARBOR_LEAF_KEY_SOURCE HARBOR_CA_CERT_SOURCE
export HARBOR_CERT_DIR HARBOR_CERT_DEST HARBOR_KEY_DEST HARBOR_CA_CERT_DEST
export HARBOR_ADMIN_PASSWORD HARBOR_DB_PASSWORD INSTALL_TRIVY INSTALL_DOCKER ALLOW_UNDERSIZED_LAB CONFIGURE_UFW
export DOCKER_DATA_ROOT CONTAINERD_ROOT CONFIGURE_CONTAINERD_ROOT DOCKER_LOG_MAX_SIZE DOCKER_LOG_MAX_FILE IMAGE_TRANSFER_ROOT
